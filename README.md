...
* **Lenguaje:** Python
* **Frontend / Despliegue:** Streamlit & Streamlit Community Cloud
* **Inteligencia Artificial:** Groq API
* **Modelo Base:** Meta Llama 3.1 (8B Instant)
...
---
[cite_start]*Desarrollado por César Marqués Jiménez* [cite: 2, 5]